...
This script is embedded in the img2model Rust binary and executed inside the
`trellis2` conda environment. It communicates progress back to the Rust host
via `@@STAGE <json>` lines on stdout.
"""
import argparse
import json
import os
